...
func assertMappy(t *testing.T, h *Hash, cmp map[Hashable]interface{}) {
	if e := h.Verify(); e != nil {
...
func fiddleHash(t *testing.T, h *Hash, s string, do, done chan bool) {
	<-do
	cmp := make(map[Hashable]interface{})
	n := 100000
	for i := 0; i < n; i++ {
...
func (self hashInt) Equals(t interface{}) bool {
...
func TestPutIfPresent(t *testing.T) {
	h := NewHash()
	assertMappy(t, h, map[Hashable]interface{}{})
	...
	assertMappy(t, h, map[Hashable]interface{}{StringKey("k"): StringKey("v")})
	...
	assertMappy(t, h, map[Hashable]interface{}{StringKey("k"): StringKey("v2")})
	if h.PutIfPresent(StringKey("k"), StringKey("v2"), StringKey("v")) {
		t.Error(h, "should not contain 'k': 'v'")
	}
	assertMappy(t, h, map[Hashable]interface{}{StringKey("k"): StringKey("v2")})
	...
	assertMappy(t, h, map[Hashable]interface{}{StringKey("k"): StringKey("v3")})
}
...
func TestNilValues(t *testing.T) {
	...
	assertMappy(t, h, map[Hashable]interface{}{StringKey("k"): nil})
...
func TestPutIfMissing(t *testing.T) {
	...
	assertMappy(t, h, map[Hashable]interface{}{StringKey("k"): "v"})
	if h.PutIfMissing(StringKey("k"), "v") {
		t.Error(h, "should contain 'k'")
	}
	assertMappy(t, h, map[Hashable]interface{}{StringKey("k"): "v"})
...
func TestHashEach(t *testing.T) {
	...
	m := make(map[Hashable]interface{})

	h.Each(func(k Hashable, v interface{}) bool {
		m[k] = v
		return false
	})
...
func TestHashEachInterrupt(t *testing.T) {
	...
	interrupted := h.Each(func(k Hashable, v interface{}) bool {
		m[k] = v
...
func TestPutDelete(t *testing.T) {
	...
	assertMappy(t, h, map[Hashable]interface{}{StringKey("a"): "b"})
	h.Put(StringKey("a"), "b")
	if v, _ := h.Delete(StringKey("e")); v != nil {
		t.Error(h, "should not be able to delete 'e' but got ", v)
	}
	...
	assertMappy(t, h, map[Hashable]interface{}{StringKey("a"): "b", StringKey("c"): "d"})
	...
	assertMappy(t, h, map[Hashable]interface{}{StringKey("c"): "d"})
