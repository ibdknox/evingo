...
type ListIterator func(t interface{}) bool
...
*/
func (self *List) Push(t interface{}) {
	self.element.add(t)
...
*/
func (self *List) Pop() (rval interface{}, ok bool) {
...
/*
 ToSlice returns a []interface{} that is logically identical to the List.
*/
func (self *List) ToSlice() []interface{} {
...
*/
func (self *List) Search(c Comparable) interface{} {
...
func (self *element) val() interface{} {
	if self == nil {
		return nil
	}
	return self.value
...
func (self *element) add(c interface{}) (rval bool) {
	alloc := &element{}
	for {
		/*
...
func (self *element) addBefore(t interface{}, allocatedElement, before *element) bool {
	if self.next() != before {
		return false
	}
...
func (self *element) ToSlice() []interface{} {
		...
		if last != &list_head {
			if comp, ok := value.(Comparable); ok {
				if comp.Compare(last) < 0 {
					bad = append(bad, []interface{}{last, value})
				}
			}
		}
		seen[current] = true
...
func (self *element) remove() (rval interface{}, ok bool) {
	n := self.next()
	for {
		/*
