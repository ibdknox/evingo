...
type HashIterator func(k Hashable, v interface{}) bool
...
func (self IntKey) Equals(t interface{}) bool {
...
func (self StringKey) Equals(t interface{}) bool {
...
func newRealEntryWithHashCode(k Hashable, v interface{}, hc uint32) *entry {
	return &entry{hc, reverse(hc) | 1, k, unsafe.Pointer(&v)}
}
func newRealEntry(k Hashable, v interface{}) *entry {
...
func (self *entry) val() interface{} {
	if self.value == nil {
		return nil
	}
	return *(*interface{})(atomic.LoadPointer(&self.value))
}
func (self *entry) String() string {
	return fmt.Sprintf("&entry{%0.32b/%0.32b, %v=>%v}", self.hashCode, self.hashKey, self.key, self.val())
}
func (self *entry) Compare(t interface{}) int {
	if t == nil {
		return 1
	}
	if e, ok := t.(*entry); ok {
...
func (self *Hash) Each(i HashIterator) bool {
	return self.getBucketByHashCode(0).each(func(t interface{}) bool {
		e := t.(*entry)
...
/*
 ToMap returns a map[Hashable]interface{} that is logically identical to the Hash.
*/
func (self *Hash) ToMap() map[Hashable]interface{} {
	rval := make(map[Hashable]interface{})

	self.Each(func(k Hashable, v interface{}) bool {
		rval[k] = v
		return false
	})
...
*/
func (self *Hash) GetHC(hashCode uint32, k Hashable) (rval interface{}, ok bool) {
...
*/
func (self *Hash) Get(k Hashable) (interface{}, bool) {
...
/*
 ...
 Use this when you already have the hash code and don't want to force gotomic to calculate it again.
*/
func (self *Hash) DeleteHC(hashCode uint32, k Hashable) (rval interface{}, ok bool) {
	testEntry := newRealEntryWithHashCode(k, nil, hashCode)
	for {
		bucket := self.getBucketByHashCode(testEntry.hashCode)
		hit := (*hashHit)(bucket.search(testEntry))
...
*/
func (self *Hash) Delete(k Hashable) (interface{}, bool) {
...
*/
func (self *Hash) PutIfPresent(k Hashable, v interface{}, expected Equalable) (rval bool) {
	...
	for {
		...
		if hit2 := hit.search(newEntry); hit2.element == nil {
			...
			if expected.Equals(*(*interface{})(oldValuePtr)) {
...
*/
func (self *Hash) PutIfMissing(k Hashable, v interface{}) (rval bool) {
	newEntry := newRealEntry(k, v)
	alloc := &element{}
	for {
		bucket := self.getBucketByHashCode(newEntry.hashCode)
...
/*
 ...
 Use this when you already have the hash code and don't want to force gotomic to calculate it again.
*/
func (self *Hash) PutHC(hashCode uint32, k Hashable, v interface{}) (rval interface{}, ok bool) {
...
*/
func (self *Hash) Put(k Hashable, v interface{}) (rval interface{}, ok bool) {
